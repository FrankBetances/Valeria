...
export const EN: UiStrings = {
  ...
  awards: {
    ...
    badgeDesc: (id: string): string => ({
      primera: 'Lúa takes her first step on the language trail.',
      ses10: '10 sessions walking and learning together.',
      ses25: '25 sessions discovering new words with Lúa.',
      ses50: '50 sessions: Lúa knows the trail by heart.',
      ses100: '100 sessions: an unbreakable lifelong bond.',
      racha3: '3 days in a row making Lúa’s bell ring bright.',
      racha7: '7 days in a row of practice and clear voice.',
      racha14: '14 days in a row: Lúa’s voice resounds with joy.',
      racha30: 'A whole month of daily practice with ringing chime.',
      perfecta: 'Perfect session (3★): Lúa’s ears catch every single sound.',
      perf5: '5 perfect sessions catching even the softest whisper.',
      perf10: '10 flawless sessions of auditory discrimination.',
      madrugadora: 'Practise in the morning to awaken Lúa’s ears.',
      nocturna: 'Calm evening session: Lúa rests in peaceful harmony.',
      finde: 'Weekend of playful words and family fun.',
      maraton: 'Six or more exercises in one session weaving endless tales.',
      regreso: 'Lúa purrs with delight to see you back practising!',
      nivel10: 'Reach Level 10: Lúa wears her brightest golden crown.',
    }[id] ?? ''),
  },
  ...
  writing: {
    ...
    tabCritical: 'Critical Letters (b / d)',
    tabWarmup: 'Warm-up & Loops',
    tabWords: 'Words & Pairs',
    tabFree: 'Free Chalkboard',
    hearModel: 'Hear sound',
