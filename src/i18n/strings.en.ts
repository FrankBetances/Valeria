...
export const EN: UiStrings = {
  ...
  academy: {
    ...
    nextStepKicker: 'START HERE',
    nextStepReason: (domain: string): string => `Suggested by the patient record: ${domain}.`,
  ...
  luaHub: {
    ...
    secAssessmentTitle: 'Exercises with Lúa',
    secAssessmentSub: 'Lúa asks for one thing at a time, graded by age. Right or wrong, she says it back properly, without telling the child off.',
    secAssessmentBadge: (n: number): string => `${n} exercises`,
    ...
    evalProgress: (curr: number, total: number): string => `Exercise ${curr} of ${total}`,
    evalClinicalSupport: 'Caregiver clinical guidance',
    evalAdultCue: 'For the adult',
    ...
    evalPlayAudio: 'Listen again',
    evalNextQuestion: 'Next exercise →',
    evalPrevQuestion: '← Previous',
    evalFinishBand: 'Complete series',
    evalBandCompletedTitle: 'Series completed!',
    evalBandCompletedSub: 'You did every exercise for this age with Lúa.',
