...
export const EN: UiStrings = {
  ...
  luaHub: {
    ...
    secPrintablesTitle: 'Print and Play',
    secPrintablesSub: '10 printable resources: emotion wheel, daily visual routines and award certificates.',
    secPrintablesBadge: (n: number): string => `${n} printables`,
