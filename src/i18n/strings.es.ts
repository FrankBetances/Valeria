...
export const ES = {
  ...
  luaHub: {
    ...
    secAssessmentTitle: 'Banco de Preguntas Interactivas',
    secAssessmentSub: '60 actividades de evaluación clínica lúdica con modelado sin castigo.',
    secAssessmentBadge: (n: number): string => `${n} preguntas`,
    ...
    evalPlayAudio: 'Escuchar pregunta',
    evalNextQuestion: 'Siguiente actividad →',
    evalPrevQuestion: '← Anterior',
    evalFinishBand: 'Completar serie',
    evalBandCompletedTitle: '¡Serie completada!',
    evalBandCompletedSub: 'Has recorrido todas las actividades de esta etapa con Lúa.',
