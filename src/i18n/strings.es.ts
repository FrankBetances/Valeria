...
export const ES = {
  ...
  hub: {
    ...
    luaSub: 'Banco interactivo de lenguaje, cuentos, canciones e imprimibles por edad (0 a 10 años).',
    luaBrief: 'Lenguaje, cuentos y canciones.',
  ...
  academy: {
    ...
    nextStepKicker: 'EMPIEZA POR AQUÍ',
    nextStepReason: (domain: string): string => `Sugerido por la ficha: ${domain}.`,
  ...
  luaHub: {
    ...
    subtitle: 'Actividades de lenguaje y comunicación por edad',
    allAges: 'Todas',
    band02: '0–2 años',
    band23: '2–3 años',
    band34: '3–4 años',
    ...
    band57: '5–7 años',
    band710: '7–10 años',
    bandSubtitle02: 'Atención conjunta, imitación y vocalizaciones',
    bandSubtitle23: 'Vocabulario y fonología temprana',
    bandSubtitle34: 'Instrucciones, pragmática y fluidez suave',
    bandSubtitle45: 'Narrativa, sintaxis y conceptos',
    bandSubtitle57: 'Conciencia fonológica y estrategias de fluidez',
    bandSubtitle710: 'Lenguaje abstracto, narrativa compleja y autorregulación',

    secAssessmentTitle: 'Ejercicios con Lúa',
    secAssessmentSub: 'Lúa pide una cosa cada vez, graduada por edad. Acierte o no, se la devuelve bien dicha, sin decirle que está mal.',
    secAssessmentBadge: (n: number): string => `${n} ejercicios`,
    secStoriesTitle: 'Cuentos con Lúa',
    secStoriesSub: '10 historias ilustradas con comprensión, vocabulario clave y dibujo libre.',
    secStoriesBadge: (n: number): string => `${n} cuentos`,
    ...
    evalProgress: (curr: number, total: number): string => `Ejercicio ${curr} de ${total}`,
    evalClinicalSupport: 'Pauta de apoyo para el adulto',
    evalAdultCue: 'Para el adulto',
    ...
    evalPlayAudio: 'Escuchar otra vez',
    evalNextQuestion: 'Siguiente ejercicio →',
    evalPrevQuestion: '← Anterior',
    evalFinishBand: 'Completar serie',
    evalBandCompletedTitle: '¡Serie completada!',
    evalBandCompletedSub: 'Has hecho todos los ejercicios de esta edad con Lúa.',
    evalBackToHub: 'Volver al módulo',
    evalTryAgain: 'Repetir serie',

    storyPages: (curr: number, total: number): string => `Página ${curr} de ${total}`,
    storyReadAloud: 'Leer en voz alta',
