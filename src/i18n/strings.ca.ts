...
export const CA: UiStrings = {
  ...
  hub: {
    ...
    luaTitle: 'Aventures amb la Lúa',
    luaSub: 'Banc interactiu de llenguatge, contes, cançons i imprimibles per edat (0 a 10 anys).',
    luaBrief: 'Llenguatge, contes i cançons.',
    luaA11y: (n: number): string => `Obrir Aventures amb la Lúa, ${n} activitats interactives`,
  ...
  academy: {
    ...
    nextStepKicker: 'COMENÇA PER AQUÍ',
    nextStepReason: (domain: string): string => `Suggerit per la fitxa: ${domain}.`,
  ...
  luaHub: {
    title: 'Aventures amb la Lúa',
    subtitle: 'Activitats de llenguatge i comunicació per edat',
    allAges: 'Totes',
    band02: '0–2 anys',
    band23: '2–3 anys',
    band34: '3–4 anys',
    ...
    band57: '5–7 anys',
    band710: '7–10 anys',
    bandSubtitle02: 'Atenció conjunta, imitació i vocalitzacions',
    bandSubtitle23: 'Vocabulari i fonologia primerenca',
    bandSubtitle34: 'Instruccions, pragmàtica i fluïdesa suau',
    bandSubtitle45: 'Narrativa, sintaxi i conceptes',
    bandSubtitle57: 'Consciència fonològica i estratègies de fluïdesa',
    bandSubtitle710: 'Llenguatge abstracte, narrativa complexa i autoregulació',

    secAssessmentTitle: 'Exercicis amb la Lúa',
    secAssessmentSub: 'La Lúa demana una cosa cada vegada, graduada per edat. L\'encerti o no, l\'hi torna ben dita, sense dir-li que està malament.',
    secAssessmentBadge: (n: number): string => `${n} exercicis`,
    secStoriesTitle: 'Contes amb la Lúa',
    secStoriesSub: '10 històries il·lustrades amb comprensió, vocabulari clau i dibuix lliure.',
    secStoriesBadge: (n: number): string => `${n} contes`,
    secSongsTitle: 'Cançons i Pràxies',
    secSongsSub: '10 cançons amb pauses actives, ritme i patrons motors orofacials.',
    secSongsBadge: (n: number): string => `${n} cançons`,

    evalProgress: (curr: number, total: number): string => `Exercici ${curr} de ${total}`,
    evalClinicalSupport: 'Pauta de suport per a l\'adult',
    evalAdultCue: 'Per a l\'adult',
    evalAdultRecord: 'Registre de l\'adult',
    evalAdultRecordHint: 'Observa el nen i marca què ha fet. Això no ho tria ell.',
    activityFinish: 'Acabar i guanyar premi',
    activityDone: 'Activitat completada! La Lúa ho ha vist.',
    ...
    secGamesSub: 'Jocs de selecció: memòria, imatge-paraula, sons inicials, seqüències, classificació, atenció i pistes.',
    ...
    evalPlayAudio: 'Escoltar un altre cop',
    evalNextQuestion: 'Següent exercici →',
    evalPrevQuestion: '← Anterior',
    evalFinishBand: 'Completar sèrie',
    evalBandCompletedTitle: 'Sèrie completada!',
    evalBandCompletedSub: 'Has fet tots els exercicis d\'aquesta edat amb la Lúa.',
    evalBackToHub: 'Tornar al mòdul',
    evalTryAgain: 'Repetir sèrie',

    storyPages: (curr: number, total: number): string => `Pàgina ${curr} de ${total}`,
    storyReadAloud: 'Llegir en veu alta',
    storyVocabTitle: 'Vocabulari clau',
    storyQuestionsTitle: 'Preguntes de comprensió',
