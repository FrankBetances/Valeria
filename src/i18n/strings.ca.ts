...
export const CA: UiStrings = {
  ...
  luaHub: {
    ...
    secAssessmentTitle: 'Banc de Preguntes Interactives',
    secAssessmentSub: '60 activitats d\'avaluació clínica lúdica amb modelatge sense càstig.',
    secAssessmentBadge: (n: number): string => `${n} preguntes`,
    ...
    secPrintablesTitle: 'Imprimeix i Juga',
    secPrintablesSub: '10 recursos per imprimir: ruleta d\'emocions, seqüències i diplomes.',
    secPrintablesBadge: (n: number): string => `${n} fitxes`,
    ...
    evalPlayAudio: 'Escoltar pregunta',
    evalNextQuestion: 'Següent activitat →',
    evalPrevQuestion: '← Anterior',
    evalFinishBand: 'Completar sèrie',
    evalBandCompletedTitle: 'Sèrie completada!',
    evalBandCompletedSub: 'Has completat totes les activitats d\'aquesta etapa amb la Lúa.',
