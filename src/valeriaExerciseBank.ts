...
export const DB: Record<string, Exercise> = {
  ...
  se1: { ...meta('se1'),
    ...
    ept: ['Todavía no encuentra la palabra que no va con las demás.', 'La encuentra cuando le haces una pregunta de ayuda («¿cuáles se comen?»).', 'La encuentra él solo y explica por qué no va con las otras.'] },
  se2: { ...meta('se2'),
  ...
  tea5: { ...meta('tea5'),
    read: 'Pulsa 🔊 para oír las cuatro palabras. Tres van juntas y una no: el niño toca la que NO va con las demás. Después sube POCO A POCO el ruido de fondo desde el Panel del Adulto y repite con otra ronda: anota cómo cambia el acierto con cada nivel de ruido.',
    stage: 'intruder', stageLabel: 'Toca la palabra que no va con las demás',
  ...
  dx2: { ...meta('dx2'),
    read: 'El niño lee la frase de la pantalla en voz alta, de un tirón y sin silabear. Cuando lo consiga en calma, activa la Gata Distractora y algo de ruido desde el Panel del Adulto y repite con otra ronda: valora tú la fluidez, no la app.',
    ...
    ept: ['Silabea o se detiene en cada palabra, incluso sin distractores.', 'Lee fluido en silencio, pero vuelve a silabear con la gata o el ruido.', 'Mantiene la lectura fluida incluso con interferencia visual y ruido.'] },
  dx3: { ...meta('dx3'),
  ...
  dx5: { ...meta('dx5'),
    read: 'Di al niño qué letra buscar (la grande del recuadro) y que toque TODAS las que encuentre en el panel. Las letras gemelas giradas (b/d, p/q) intentan engañarle. Si quieres carga extra, activa la Gata Distractora desde el Panel del Adulto.',
...
export const VARIANTS: Record<string, Partial<Exercise>[]> = {
  ...
  se1: [
    {},
    {
      read: 'Pulsa 🔊 para oír el nombre de las cuatro palabras. Tres son animales y una no. El niño toca la que NO va con las demás.',
      intruder: [{ cap: 'perro', emoji: '🐶' }, { cap: 'gato', emoji: '🐱' }, { cap: 'vaca', emoji: '🐄' }, { cap: 'zapato', emoji: '👟' }],
      intruderAnswer: 3,
    },
    {
      read: 'Pulsa 🔊 para oír el nombre de las cuatro palabras. Tres son para vestirse y una no. El niño toca la que NO va con las demás.',
  ...
  tea5: [
    {},
    {
      read: 'Pulsa 🔊 para oír las cuatro palabras. Tres se comen y una no: el niño toca la que NO va con las demás. Sube el ruido desde el Panel del Adulto ronda a ronda y anota cómo cambia el acierto.',
      intruder: [{ cap: 'manzana', emoji: '🍎' }, { cap: 'pan', emoji: '🍞' }, { cap: 'queso', emoji: '🧀' }, { cap: 'pelota', emoji: '⚽' }],
      intruderAnswer: 3,
    },
    {
      read: 'Pulsa 🔊 para oír las cuatro palabras. Tres son para vestirse y una no: el niño toca la que NO va con las demás. Mantén el nivel de ruido que estés probando y compara con las rondas anteriores.',
...
// Etiquetas de plural por variedad: eu pospone "bat"/"asko" sin género; gl usa
