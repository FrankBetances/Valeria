...
export const ROLESWAP_INTRO = '¡Cambio de papeles! Ahora manda el niño y habla el adulto.';
export const ROLESWAP_NOT_HEARD = 'No escuché bien al adulto. ¡Otra vez!';
...
export const roleswapParentSaid = (word: string): string =>
  `¡Uy! El adulto dijo ${word}. ¡Escucha otra vez en el próximo turno!`;
