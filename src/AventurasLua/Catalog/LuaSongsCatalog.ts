...
export const LUA_SONGS_CATALOG: LuaSong[] = [
  ...
  },
  {
    ...
    theme: 'conteo',
    consigna: 'Canta con Lúa. Cada vez que digas un número, toca la manzana en la pantalla.',
    lyrics: [
    ...
    interactiveTask: {
      title: 'Cuenta y toca 10 manzanas',
      description: 'Toca las 10 manzanas numeradas del 1 al 10 en orden para llenar el canasto.',
      actionType: 'counter',
  ...
  },
  {
    ...
    lyrics: [
      ...
      'manzana, uvas y fresa también,',
      'damos vueltas y vueltas,',
      'cantando mi canción otra vez,',
      'plátano dulce y maduro,',
    ...
    interactiveTask: {
      ...
      description: 'Toca la manzana, el plátano/banana, las uvas y las fresas en el frutero.',
      actionType: 'drawing',
      elements: ['Manzana', 'Plátano / Banana', 'Uvas', 'Fresas'],
    },
  },
  {
    id: 'lua_song_09',
