...
export const ACADEMY_CAPSULES_ES: AcademyCapsule[] = [
  ...
  },
  {
    ...
    track: 'desarrollo',
    icon: '🏓',
    title: '¿Y si escucharas antes de hablar?',
  ...
  // ------------------------------------------------------------------- vicios
  {
    ...
    track: 'vicios',
    icon: '🚫',
    title: '¿Y si en vez de corregir, remodelaras?',
  ...
  },
  {
    ...
    track: 'vicios',
    icon: '❓',
    title: '¿Cómo evaluar sin que se note?',
  ...
  // ------------------------------------------------------------------ mediada
  {
    ...
    track: 'mediada',
    icon: '🧑‍🏫',
    title: '¿Sabías que ya eres terapeuta?',
...

  {
    ...
    track: 'desarrollo',
    icon: '🎙️',
    title: '¿Por qué narrar lo que ves?',
  ...
  },
  {
    ...
    track: 'mediada',
    icon: '🌱',
    title: '¿Cómo enriquecer lo que dice?',
  ...
  // =============================================================== DISLALIAS
  {
    ...
    track: 'tpr',
    icon: '👅',
    title: '¿Dónde se coloca cada sonido?',
...

  {
    ...
    track: 'desarrollo',
    icon: '📅',
    title: '¿A qué edad se aprende cada sonido?',
  ...
  },
  {
    ...
    track: 'tpr',
    icon: '🐯',
    title: '¿Cómo ayudar con la erre con calma?',
  ...
  },
  {
    ...
    track: 'tpr',
    icon: '👄',
    title: '¿Sirve la gimnasia de la boca?',
  ...
  // que son las dos preguntas que aparecen la primera vez.
  {
    ...
    track: 'tpr',
    icon: '🎯',
    title: '¿Por qué premiar el gesto antes del sonido?',
  ...
  // ================================================================ DISLEXIA
  {
    ...
    track: 'desarrollo',
    icon: '🔤',
    title: '¿Cómo jugar con los sonidos del habla?',
...

  {
    ...
    track: 'desarrollo',
    icon: '🚦',
    title: '¿A qué señales debemos estar atentos?',
  ...
  },
  {
    ...
    track: 'desarrollo',
    icon: '🎶',
    title: '¿Por qué importan las rimas y sílabas?',
  ...
  },
  {
    ...
    track: 'mediada',
    icon: '📚',
    title: '¿Cómo leer juntos sin presión?',
  ...
  // ===================================================================== TEA
  {
    ...
    track: 'mediada',
    icon: '🧩',
    title: '¿Por qué anticipar da tanta seguridad?',
  ...
  },
  {
    ...
    track: 'mediada',
    icon: '🖼️',
    title: '¿Cómo ayudan los apoyos visuales?',
  ...
  },
  {
    ...
    track: 'tpr',
    icon: '🙌',
    title: '¿Cómo enseñar a pedir lo necesario?',
  ...
  },
  {
    ...
    track: 'desarrollo',
    icon: '🚂',
    title: '¿Y si sus intereses fueran la puerta?',
  ...
  //    dejar dos mensajes sueltos que parecen reñidos.
  {
    ...
    track: 'desarrollo',
    icon: '🤟',
    title: '¿Sabías que la LSE es una lengua completa?',
  ...
  },
  {
    ...
    track: 'tpr',
    icon: '🔤',
    title: '¿Cómo funciona el alfabeto dactilológico?',
  ...
  },
  {
    ...
    track: 'tpr',
    icon: '🙌',
    title: '¿Cuáles son los primeros signos útiles en casa?',
  ...
  },
  {
    ...
    track: 'mediada',
    icon: '🧑‍🏫',
    title: '¿Dónde se aprende lengua de signos de verdad?',
  ...
  //      observar y con quién hablarlo.
  {
    ...
    track: 'mitos',
    icon: '🦜',
    title: '¿Se aprende a hablar solo imitando?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '⏳',
    title: '¿Conviene esperar a que hable solo?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '📺',
    title: '¿Los vídeos realmente enseñan a hablar?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '🌍',
    title: '¿Tener dos idiomas confunde al niño?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '👅',
    title: '¿Cortar el frenillo lo soluciona todo?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '🧩',
    title: '¿Qué mitos existen sobre el autismo?',
  ...
  },
  {
    ...
    track: 'mitos',
    icon: '🔤',
    title: '¿Qué mitos existen sobre la dislexia?',
