...
export const ROLESWAP_INTRO_GL = 'Cambio de papeis! Agora manda o neno e fala o adulto.';
export const ROLESWAP_NOT_HEARD_GL = 'Non escoitei ben o adulto. Outra vez!';
...
export const roleswapParentSaidGl = (word: string): string =>
  `Ui! O adulto dixo ${word}. Escoita outra vez na próxima quenda!`;
