...
| **EN-4.4** ⏳ | Medir el impacto en tamaño y decidir según EN-0.6 si todo viaja en el mismo binario o se descarga bajo demanda. **Primera medida real (ago 2026): el banco `en` de hoy son 27 locuciones · 73,8 s · 400 KB.** Nada que decidir todavía —el presupuesto se juega en la Fase 3—, pero sí sirve para extrapolar: el corpus castellano son 878 locuciones, así que un banco inglés completo se moverá en el orden de los **~10 MB** de las demás variedades, no por encima. La síntesis tardó **37 s** de CI | Nota de tamaño en este documento ✅; ⏳ CA: build EAS dentro del presupuesto, cuando exista el banco completo |
