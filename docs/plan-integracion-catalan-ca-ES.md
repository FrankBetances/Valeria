...
| ~~Validació del català~~ | **FET** (29/8/2026): **Maria**, parlant nativa de Barcelona, ha validat lèxic, registre i normativa del central als quatre bancs. Confirma també la decisió del betacisme (/b/–/v/ fora) i que els parells són paraules que una criatura de 3 a 6 anys de Barcelona reconeix. | — |
| **Criteri logopèdic** | És l'altre eix, i el repositori sempre els ha distingit: el gallec porta «revisió de galego normativo **e** criterio logopédico», l'euskera «revisión logopédica de Ulertuz **y** de euskera normativo». La validació de la Maria cobreix la LLENGUA; el criteri clínic dels 12 parells, les progressions i els EPT-3 encara no té firma. | El contingut és a producció darrere del commutador `CA_THERAPY_CONTENT_READY` de `valeriaLocale.ts`: si la revisió clínica hi troba res, es baixa aquest booleà i la varietat torna al castellà sense tocar res més. |
