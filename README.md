...
| 🐱 **Aventuras con Lúa** (109 actividades) · [captura](docs/screenshots/43-aventuras-lua-ficha.png) | El material de *Lúa y las Palabras* llevado a la app, en cuatro secciones y seis franjas de edad (0‑2 · 2‑3 · 3‑4 · 4‑5 · 5‑7 · 7‑10): **19 juegos** (memorama, imagen‑palabra, cazador de sonidos, secuencias, atención, pistas progresivas), con el léxico dominicano de la *Matriz de Contenidos por Edad* —mango, lechosa, chinola, guineo, coco, la palma, el coquí, la tambora—, **60 preguntas** del banco por edad, **10 cuentos** con comprensión y vocabulario, **10 canciones** de ritmo y praxias, y **10 imprimibles** con la ficha dibujada —tarjetas recortables, rueda de emociones, dominó de rimas, diploma—. Cada ítem distingue lo que **toca el niño** (opciones con pictograma del banco propio, porque por debajo de 4 años no se lee) de lo que **observa el adulto** (hoja de registro, que no se locuta). Al fallar suena una devolución dirigida al niño, nunca la pauta clínica del terapeuta. Contenido de pantalla y locución **solo en castellano** de momento; los diez cuentos son los de las 50 hojas, no los de la matriz (de esos solo hay títulos). |
