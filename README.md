...
[`site/`](site/) y el formulario de *Seguridad de los datos* de Play Console. Las
respuestas de ese formulario, con la prueba de código al lado de cada una, están en
[`docs/play-console-seguridad-datos.md`](docs/play-console-seguridad-datos.md), y
`check-data-safety-declaration.js` rompe el build cuando el código se aleja de ellas.
...
| `check-data-safety-declaration.js` | Que el código se aleje de lo que declara el formulario de *Seguridad de los datos* de Play Console. Vigila seis cosas: un campo nuevo en la ficha del paciente, un permiso nuevo, una dependencia nueva (el caso «SDK de terceros»), una llamada de red propia estrenada, el cableado de la sincronización en la nube —hoy inalcanzable— y que la versión coincida en `app.json`, las dos políticas y el documento. Ver [`docs/play-console-seguridad-datos.md`](docs/play-console-seguridad-datos.md) |
