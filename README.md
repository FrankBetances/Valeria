...
| --- | --- |
| **Manual de usuario con casos de uso** (v15) · [HTML](docs/manual-casos-de-uso.html) · [PDF](docs/Valeria-Manual-Casos-de-Uso.pdf) · [Word](docs/Valeria-Manual-Casos-de-Uso.docx) | **28 casos de uso** paso a paso ilustrados con capturas reales (`docs/screenshots/`): **Academy · hub de formación multidominio (CU‑03)**, los **diez bloques** (Integración Sensorial Auditiva, **Aventuras con Lúa** (CU‑28), Pares Mínimos, Expansión Semántica, Audición, Lenguaje, TEA, Dislexia, Grafomotricidad y **Realidad Aumentada**), el hub, la gráfica de sustitución por fonema, la telemetría del piloto (CU‑14), la variedad lingüística (CU‑15), el Panel del Adulto / carga comunicativa (CU‑16), el **módulo de Lengua de Signos Española (CU‑17)** y el **bloque de Realidad Aumentada completo (CU‑18 a CU‑22 y CU‑25 a CU‑27)**: permiso de cámara, prueba de aptitud, **los seis ejercicios** y los umbrales clínicos. El capítulo de RA no lleva capturas a propósito —esos ejercicios necesitan la cámara abierta y cualquier captura fiel mostraría la cara de un menor—. Incluye el **Anexo C** sobre el periférico físico. |
