...
| [`docs/plan-integracion-ingles-en-US.md`](docs/plan-integracion-ingles-en-US.md) | **Propuesta** de plan por fases para el inglés de Estados Unidos (`en‑US`). Rompe el molde de los tres planes de idioma anteriores: es el primero que exige **traducir la interfaz** (hoy no hay i18n de UI: las cadenas están literales en las 27 pantallas), el primero que abre **mercado nuevo** (COPPA, *Designed for Families*, ficha de tienda y página de eliminación de datos en inglés) y el que más rediseño clínico pide (grupos consonánticos, vocales tensa/laxa, ortografía opaca). Incluye la regla bloqueante de **diferencia dialectal vs. trastorno** para AAVE e inglés sureño, espejo de la guía dominicana. |
